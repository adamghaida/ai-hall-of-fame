...
| **[AlphaProteo — protein binders designed on demand, in one round](./alphaproteo-binders/)** | September 2024 · DeepMind | Binders for seven targets with 3–300× better affinity than prior methods, from a single screening round — and a published failure on the eighth. |
