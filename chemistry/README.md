...
| **[Abaucin — a deep-learning hit aimed at one of the hardest superbugs](./abaucin-antibiotic/)** | May 2023 · Nature Chemical Biology | A neural network trained on 7,500 molecules found a compound that kills one hospital superbug and almost nothing else. |
| **[Planning chemical syntheses with deep neural networks](./retrosynthesis-deep-learning/)** | March 2018 · Nature | AI planned multi-step routes to build target molecules twice as often, and 30x faster, than decades-old rule-based software. |
