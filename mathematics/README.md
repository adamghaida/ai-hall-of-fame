...
Proving theorems, cracking open problems, and discovering algorithms that eluded humans for decades.

| Case | When | In one line |
|------|------|-------------|
| **[Finite-time blowup for the (forced) Navier–Stokes equations — an AI claim on a Millennium Prize Problem](./navier-stokes-finite-time-blowup/)** | September 2026 | OpenAI reports that about 10,000 agents proved a smooth fluid can blow up under a smooth force, with a Lean formalization. Forced case only, not yet verified outside OpenAI, and a credit dispute with the mathematicians who proved the Euler case first. |
...
| **[A claimed proof of the Cycle Double Cover Conjecture (GPT-5.6 Sol Ultra)](./cycle-double-cover-conjecture/)** | July 2026 | A three-page proof of a 1970s graph-theory conjecture, produced by 64 subagents in under an hour: credible, Lean-checked, and still not peer reviewed. |
| **[AlphaProof Nexus: 9 of 353 open Erdős problems and 44 of 492 OEIS conjectures, every proof in Lean](./alphaproof-nexus/)** | May 2026 | DeepMind's Lean-checked proof-search agent swept every formalized open Erdős problem, solved nine at a few hundred dollars each, and published the failures too. Two statements amended after the fact, two later matched to literature, success rate around 2 percent. |
| **[Erdős problem 1196 solved from a single GPT-5.4 Pro prompt, then digested into a paper with Terence Tao](./erdos-1196-single-prompt/)** | April 2026 | A 1966 Erdős–Sárközy–Szemerédi conjecture on primitive sets, one experts had worked on, solved in one response to a 23-year-old's prompt via a Markov chain the field had overlooked since 1935. Paper still a work in progress. |
| **[Erdős problem 728: the first Erdős problem resolved autonomously by AI, with a Lean proof](./erdos-728-first-autonomous-lean/)** | January 2026 | GPT-5.2 Pro wrote the argument, Harmonic's Aristotle formalized it in Lean, and no prior solution was found; problems 729 and 401 fell the same week. Ambiguous statement, method close to Pomerance, and deliberately low-hanging fruit. |
| **[Erdős's unit distance conjecture disproved by an OpenAI model (Erdős problem 90)](./erdos-90-unit-distance-disproof/)** | May 2026 | An 80-year-old conjecture in combinatorial geometry, disproved autonomously with number-field towers; Gowers said he would have recommended it to the Annals "without any hesitation." Company PDF, verified by nine external mathematicians, explicit exponent 1.014 from Sawin. |
...
| **[AlphaTensor — beating a 50-year-old matrix-multiplication record](./alphatensor-matrix-multiplication/)** | October 2022 · Nature | An AI beat a benchmark for multiplying matrices that had stood since 1969. |
| **[AlphaEvolve — breaking Strassen again, and improving ~50 open problems](./alphaevolve-algorithm-discovery/)** | May 2025 | A general-purpose discovery engine that improves real algorithms and open math bounds. |
