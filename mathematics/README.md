...
| **[The matrix multiplication exponent drops to ω < 2.371177, with AlphaEvolve as the final refinement](./matrix-multiplication-omega-alphaevolve/)** | August 2026 | A 7-million-parameter optimizer, a rational-arithmetic certificate, and AlphaEvolve rewriting the optimizer code push the record from 2.371339 to 2.371177; Alman and Vassilevska Williams are co-authors. Tiny, asymptotic, and the verification repo is still pending. |
