...
| **[AlphaEvolve improves nine classical Ramsey number lower bounds](./alphaevolve-ramsey-bounds/)** | March 2026 | R(3,13) 60→61, R(4,20) 234→237 and seven others, found by evolving search programs rather than graphs; every new graph is published with a verification notebook. Steps of 1 to 6 vertices, no upper bounds moved. |
